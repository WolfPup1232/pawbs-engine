...
class Assets
{
	...
	* @param {Function} cell The ID of the HTML DOM grid element which will contain the object thumbnail.
	*/
	...
	* @param {boolean} render_once Flag which determines whether or not to render only one frame of animation for the thumbnail.
	*/
	static objectThumbnailAnimate(animation_id, renderer, scene, camera, object, render_once = false)
	{
